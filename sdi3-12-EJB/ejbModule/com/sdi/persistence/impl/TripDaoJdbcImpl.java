...
public class TripDaoJdbcImpl implements TripDao {
	...
	@Override
	public List<Trip> findAllOpenAndPaxAvailables() {
		return jdbcTemplate.queryForList(
				"TRIP_FIND_ALL_OPEN_AND_PAX_AVAILABLES", new TripMapper());
	}
	...
	public List<Trip> find(String seach) {
		return jdbcTemplate.queryForList("TRIP_FIND", new TripMapper(), "%"
				+ seach + "%", "%" + seach + "%");
	}
