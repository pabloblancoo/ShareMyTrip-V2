...
public class FactoriesHelper {
	...
	/**
	 * Devuelve instancia de la clase factory deseada. Crea un objeto a partir * del nombre de la clase
	 *
	 * @param file
	 * El fichero de propiedades
	 * @param factoryType
	 * El nombre de la propiedad en el fichero de proerties * @return
	 * El objeto de la clase factoria adecuada */
	public static Object createFactory(String file, String factoryType) { 
